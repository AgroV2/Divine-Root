...
{
    public class StarSnakeBody : ModProjectile
    {
        public override string Texture => "DivineRoot/Content/Pets/StarSnake/bodyStarSnake";

        private const int FrameW = 14;
        private const int FrameH = 18;
        ...
        public override void AI()
        {
            ...
            Lighting.AddLight(Projectile.Center, 0.2f, 0.07f, 0.55f);
        }
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>("DivineRoot/Content/Pets/StarSnake/bodyStarSnake").Value;
